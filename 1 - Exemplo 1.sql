...
/* Mostra todos os maridos, inclusive os maridos sem esposa. O comando "outer join* considera todos os registros, inclusive os que não possuam 
nenhum relação. O comando "left outer join" considera todos os registros a esquerda do "join" e o comando "right outer join" considera todos
